...
import { CertificateIcon, EnergyIcon, TargetIcon } from '@/components/atoms/icons';
    ...
    return (
        <section className="px-4 md:px-8 py-8 md:py-12 space-y-8">
            <div className="border-l-4 border-primary pl-4 md:pl-6">
                <div className="inline-flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg mb-3">
    ...
    return (
        <section className="px-4 md:px-8 py-8 md:py-12 space-y-8">
            <div className="border-l-4 border-secondary pl-4 md:pl-6">
                <div className="inline-flex items-center gap-2 bg-secondary text-primary px-4 py-2 rounded-lg mb-3 font-bold">
    ...
    return (
        <section className="px-4 md:px-8 py-8 md:py-12 space-y-8">
            <div className="border-l-4 border-tertiary pl-4 md:pl-6">
                <div className="inline-flex items-center gap-2 bg-tertiary text-white px-4 py-2 rounded-lg mb-3">
