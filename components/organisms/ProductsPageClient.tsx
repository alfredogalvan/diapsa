 ...
 * Pagina de categorias de productos con diseno orientado a conversion
...
export default function ProductsPageClient() {
  ...
  // Filtrar solo categorias raiz para la vista principal
  ...
  return (
    <main className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-tertiary text-lg max-w-2xl mx-auto">
              ...
              Tecnología de vanguardia respaldada por marcas lideres internacionales.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-sm border border-gray-100">
              ...
              <div>
                ...
                <p className="text-tertiary text-sm leading-relaxed">
                  Todos nuestros productos cumplen con estandares internacionales
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-sm border border-gray-100">
              ...
              <div>
                ...
                <p className="text-tertiary text-sm leading-relaxed">
                  Cobertura en toda la Republica Mexicana
                </p>
              </div>
            </div>
      ...
      {/* Categorias Section - Tema Gray con glows */}
      ...
      <section className="w-full bg-primary py-16 lg:py-24 relative overflow-hidden">
        ...
        <BackgroundImage
          ...
          alt="Almacen de equipos industriales"
          overlayOpacity={0.75}
        />
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
            Nuestro equipo de expertos esta listo para asesorarte y encontrar
            la solución perfecta para tus necesidades especificas.
          </p>
          ...
          <div className="mt-10 pt-8 border-t border-white/10">
            <p className="text-white/60 text-sm mb-3">O contactenos directamente:</p>
